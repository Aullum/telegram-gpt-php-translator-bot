...
![License](https://img.shields.io/github/license/Aullum/telegram-gpt-php-translator-bot)
...
```
 ...
 ├── docker-compose.yml         # For local Docker orchestration
 ├── render.yaml                # Render.com deployment configuration
 ├── Procfile                   # Heroku deployment process file
 ├── .python-version            # Python version lock (used by pyenv/Heroku)
