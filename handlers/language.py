...
async def handle_language(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text(f"🔄 File split into {len(chunks)} parts. Starting translation...")
        ...
        for i, chunk in enumerate(chunks, 1):
            await update.message.reply_text(f"🔄 Translating part {i}/{len(chunks)}...")
